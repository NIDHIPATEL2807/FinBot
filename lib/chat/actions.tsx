...
import { LanguageModelV1, LanguageModelV1StreamPart, LanguageModelV1FunctionToolCall } from '@ai-sdk/provider';
...
const model: LanguageModelV1 = groq(MODEL) as LanguageModelV1;
    ...
    return {
      ...
      display: (
        <div className="border p-4">
          ...
          <a
            href="https://github.com/NIDHIPATEL2807/FinSynergy/issues"
            target="_blank"
